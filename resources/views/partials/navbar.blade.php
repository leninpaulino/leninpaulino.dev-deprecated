<header class="blog-header py-3 border-bottom">
    <div class="row flex-nowrap justify-content-between align-items-center">
        <div class="col-4 pt-1">
            <p class="my-auto">
                <a href="https://twitter.com/@cnvs_io" class="pr-3 text-decoration-none" target="_blank" rel="noopener">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" viewBox="0 0 24 20">
        ...
        <div class="col-4 text-center">
            <a id="brand" class="text-dark font-weight-bold text-decoration-none font-serif" href="{{ route('index') }}">{{ config('app.name', __('canvas::blog.title')) }}</a>
        </div>
        ...
        <div class="col-4 d-flex justify-content-end align-items-center">
            ...
            <div class="dropdown">
                <a href="#" class="nav-link px-0 py-0 text-secondary" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ $data['avatar'] }}" class="rounded-circle my-0 shadow-sm" style="width: 31px" alt="{{ auth()->user()->name }}">
                </a>
